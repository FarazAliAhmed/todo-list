          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-b-lg shadow-sm border p-4">
            <div className="flex space-x-4">
              <input
                ...
                className="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black placeholder:text-gray-400"
                disabled={isLoading}
              />
              <button
                type="submit"
